...
import mockTeams from "../Mock/spanish/spanish.json"
import mockFormations from "../Mock/formations.json";
import mockInjuries from "../Mock/injuries.json";
import mockBudget from "../Mock/budget.json";
import mockPlayersContract from "../Mock/playersContract.json";
import mockPlayersForeigner from "../Mock/playersForeigner.json";
import mockScouts from "../Mock/scouts.json";
import mockPlayersAges from "../Mock/playersAges.json";
        ...
        <div className={styles.areaResult}>
          ...
          {chosenTeam && (
            <div>
              <h1> Objetivos </h1>
              <span>
                <strong> Liga: </strong> {chosenTeam.objectiveTeam.league}
                <br />
                <strong> Internacionais: </strong> {chosenTeam.objectiveTeam.geral}
                <br />
